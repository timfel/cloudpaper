...
Betriebssystemvirtualisierung ist das auch durchführbar, stößt aber
auch an seine Grenzen: benötigt ein virtualisiertes Betriebssystemen
plötzlich weit mehr Speicher als vorher, weil \zB die Datenbank des
betriebenen Projektes stark vergößert wurde, ist die Grenze der
Speicher, der physisch verfügbar ist. Wachsen die Anforderungen
darüber hinaus, kann das Verschieben des virtualisierten
Betriebssystemes auf Hardware mit mehr Speicher Abhilfe schaffen.
