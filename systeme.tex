...
damit unportabel ist. VMWare ESX, als das vorgestellte System mit dem
...
implementiert werden.  Bei der \ac{ldom}-basierten Lösung ist wieder die
Einschränkung zu beachten, dass zwar Hardware eines Systems
aufgestockt und ausgetauscht werden kann, ohne Gast-\ac{VM}s herunterfahren
